...
C:\VulkanSDK\1.2.189.2\Bin\glslc.exe GLSL\f_trianglePT.frag -o SPIRV\f_trianglePT.spv
C:\VulkanSDK\1.2.189.2\Bin\glslc.exe GLSL\v_linePC.vert -o SPIRV\v_linePC.spv
C:\VulkanSDK\1.2.189.2\Bin\glslc.exe GLSL\f_linePC.frag -o SPIRV\f_linePC.spv
C:\VulkanSDK\1.2.189.2\Bin\glslc.exe GLSL\v_pointPC.vert -o SPIRV\v_pointPC.spv

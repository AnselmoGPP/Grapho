...
void main()
{
	...
	mat4 VM = mat4(mat3(gUbo.view * ubo.model));				// Take away translation and scaling from the MV matrix
	gl_Position  = (gUbo.proj * VM * vec4(inPos, 1.0)).xyww;	// this ensures depth == 1
	outPos = inPos;
}
